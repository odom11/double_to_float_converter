...
std::vector<ScannerOutput> getTestdata() {
    return std::vector<ScannerOutput>{
        ...
        std::make_pair(Token::DOUBLE, ".3e9"),
        std::make_pair(Token::DOUBLE, ".3e-9"),
        std::make_pair(Token::DOUBLE, ".3e+9"),
        ...
        std::make_pair(Token::MATH_FUNCTION, "exp"),
        ...
        std::make_pair(Token::STRING, "'\\032'"),
        std::make_pair(Token::STRING, "'OCLA'"),
        std::make_pair(Token::STRING, "\"\\\"\""),
        std::make_pair(Token::STRING, "\"$\""),
        std::make_pair(Token::STRING, "'$'"),
